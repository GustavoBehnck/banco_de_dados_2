...
urlpatterns = [
    ...
    path("clientes/<int:id>/editar", views.edit_client, name="colaborador_edit_client"),
    path("veiculos/modelos/", views.VehicleModelListView.as_view(), name="colaborador_vehicle_model_list"),
    path("veiculos/modelos/cadastrar", views.new_vehicle_model, name="colaborador_new_vehicle_model"),
    path("veiculos/modelos/<int:id>/editar", views.edit_vehicle_model, name="colaborador_edit_vehicle_model"),
    ...
    path("veiculos/<int:id>/editar", views.edit_vehicle, name="colaborador_edit_vehicle"),
    path("manutencoes/", views.MaintenanceListView.as_view(), name="colaborador_maintenance_list"),
    path("manutencoes/cadastrar", views.new_maintenence, name="colaborador_new_maintenence"),
    path("manutencoes/<int:id>/editar", views.edit_maintenence, name="colaborador_edit_maintenence"),
